...
from app.api import cross_vault_playlists
...
from app.api import image_import
...
api_router.include_router(image_import.router, prefix="/images", tags=["images"])
...
api_router.include_router(cross_vault_playlists.router, prefix="/playlists", tags=["playlists"])
