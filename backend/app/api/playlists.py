...
from app.core.vault_health import get_online_vault_ids, get_vault_health
from app.api.cross_vault_playlists import _proxy_remote_image_file
...
async def read_playlist(
    ...
    from app.api.mappers import map_image_to_schema
